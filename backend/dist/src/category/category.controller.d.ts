...
export declare class CategoryController {
    ...
    getMainCategories(): Promise<import("../schemas/category.schema").CategoryWithSubcategories[]>;
    getMainCategoriesOnly(): Promise<import("../schemas/category.schema").CategoryDocument[]>;
    getCategoriesWithSubcategories(): Promise<import("../schemas/category.schema").CategoryWithSubcategories[]>;
