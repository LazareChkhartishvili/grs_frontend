...
export declare class CategoryController {
    ...
    updateSubCategory(categoryId: string, subCategoryId: string, updateCategoryDto: any): Promise<import("../schemas/category.schema").Category>;
    getSubCategorySets(categoryId: string, subCategoryId: string): Promise<any[]>;
    createSubcategory(parentId: string, createCategoryDto: any): Promise<import("../schemas/category.schema").Category>;
