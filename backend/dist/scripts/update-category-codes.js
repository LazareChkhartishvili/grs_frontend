...
const SetSchema = new mongoose_1.Schema({
    ...
    exercises: [{
            ...
            videoId: { type: mongoose_1.Types.ObjectId, ref: 'Video' },
...
const SetModel = (0, mongoose_1.model)('Set', SetSchema);
function transformCategoryCode(code) {
...
async function updateCategoryCodes() {
    try {
        ...
        for (const set of data.sets) {
            ...
            try {
                await SetModel.updateOne({ setId: set.setCode }, { $set: setData }, { upsert: true });
...
updateCategoryCodes();
//# sourceMappingURL=update-category-codes.js.map