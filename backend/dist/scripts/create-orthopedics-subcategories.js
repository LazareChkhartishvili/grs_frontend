...
const SubCategorySchema = new mongoose_1.Schema({
    ...
    description: String,
    image: String,
    categoryId: { type: mongoose_1.Types.ObjectId, required: true },
    categoryCode: String,
...
const orthopedicSubcategories = [
    {
        ...
        isActive: true,
        categoryId: new mongoose_1.Types.ObjectId('686ab92fb5bca1e2a26ea757'),
...
const neurologySubcategories = [
    {
        ...
        isActive: true,
        categoryId: new mongoose_1.Types.ObjectId('686ab92fb5bca1e2a26ea758'),
...
async function createSubcategories() {
    try {
        await (0, mongoose_1.connect)('mongodb+srv://beruashvilig60:Berobero1234!@cluster0.dtwfws3.mongodb.net/grs-db');
...
createSubcategories();
//# sourceMappingURL=create-orthopedics-subcategories.js.map