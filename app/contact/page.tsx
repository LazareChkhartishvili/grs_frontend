...
const ClockIcon = () => (
  <svg
    className="w-7 h-7 md:w-9 md:h-9 text-[#898989]"
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
    aria-hidden="true"
      ...
      <section className="px-2 md:px-8 py-4">
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-4 mb-2 md:mb-4 w-full">
          ...
          <div className="bg-[#f7f4ff] rounded-2xl flex-1 flex flex-col justify-between p-4 gap-4 min-h-[192px]">
            <ClockIcon />
            <div>
              <div className="font-bold text-lg md:text-xl break-all">
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-4 w-full">
          ...
          <div className="bg-[#f7f4ff] rounded-2xl flex justify-center items-center p-4 mb-2 md:mb-0 w-full md:w-[453px] flex-shrink-0">
            <img
              src="/public/CostumerService.png"
              alt="ყურსასმენების ილუსტრაცია"
          ...
          <div className="bg-[#f7f4ff] rounded-2xl flex-1 px-4 py-4 md:py-5 md:px-6 flex flex-col justify-between">
            ...
            <form className="flex flex-col gap-3 md:gap-3">
              ...
              <div className="flex justify-end mt-2">
                <button
                  type="submit"
                  className="bg-[#B393F9] hover:bg-[#a179f7] text-white font-bold rounded-lg px-8 py-2 text-base md:text-lg transition"
                >
                  ОТПРАВИТЬ
                </button>
              </div>
