  ...
  return (
    <div className="overflow-x-auto scrollbar-hide">
      <div className="flex flex-row gap-4 w-max">
        <div className="bg-white p-1.5 pb-4 w-[248px] md:w-[690px] flex-shrink-0">
          {/* Mobile image */}
          <Image
          ...
          <h5 className="text-[#3D334A] mb-2 mt-4 leading-[120%]">
            Курсы и мастер-классы для опытных терапевтов. Практикум по лечению
            ортопедических проблем
          </h5>
          <p className="text-[#846FA0] mb-[14px] leading-[120%]">
          ...
          <div className="w-full flex justify-end items-end pr-4">
            <button className="bg-[#D4BAFC] py-[5px] px-4 rounded-[3px] text-[12px]">
              4023 $
            </button>
          </div>
        </div>
