...
const Subscribe = () => {
  return (
    <div className=" mb-6 md:mb-10 md:px-5">
      <div className="bg-[url('/assets/images/hero.jpg')] bg-cover w-[359px] md:w-[1400px] md:h-[404px] rounded-[20px] mx-auto md:mx-0 p-4 gap-5">
        <h1 className="mb-5 md:mb-[72px] text-[20px] md:text-[64px] md:max-w-[700px] tracking-[-3%] leading-[100%]">
