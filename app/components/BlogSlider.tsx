...
const BlogSlider = () => {
  return (
    <div className="md:mt-[50px] mt-5 w-full">
      <div className="flex md:flex-row gap-7 w-full md:flex-wrap overflow-x-auto md:overflow-x-visible px-0 md:px-4  snap-x snap-mandatory">
        ...
        <div className="flex md:grid md:grid-cols-2 gap-5 md:flex-none flex-row md:flex-wrap overflow-x-auto md:overflow-x-visible snap-x snap-mandatory">
          {[...Array(4)].map((_, index) => (
            <div
              key={index}
              className="md:w-full w-[201px] flex-shrink-0 md:p-5 p-3 bg-white flex flex-col justify-between md:rounded-[20px] rounded-[10px] snap-center"
            >
              <Image
