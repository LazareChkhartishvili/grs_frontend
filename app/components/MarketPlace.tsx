...
const MarketPlace = () => {
  return (
    <div className="bg-[#F9F7FE] md:mx-10 md:mb-10">
      ...
      <p className="text-[#3D334A] md:p-10 md:max-w-[838px] font-medium leading-[120%]">
      ...
      <span className="text-[#846FA0] items-end flex justify-end md:pr-10 md:pb-10 md:text-[32px] md:leading-[90%]">
        В разработке
      </span>
    </div>
  );
